        ...
        <q-card>
          ...
          <q-tab-panels v-model="tab" animated swipeable class="text-white">
            ...
            <q-tab-panel name="pericias">
              <q-card-section style="margin-left: 20px">
                ...
                >
                  ...
                  <q-input
                    ...
                    @input="handleSkillChange(skillName, 'proficiency', $event)"
                  />
                  <q-input
                    outlined
                    style="width: 50px"
...
export default {
  components: { PersonagemPageFormId, selectFilter, FormPage, ImagePickerVue },
